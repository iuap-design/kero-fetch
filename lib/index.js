...
//相关依赖导入
import { addDataTable, addDataTables, addAllDataTables, updateDataTables } from './server-dataTable';

import { fire, setSuccessFunc, _successFunc } from './server-fire';

import { processXHRError } from './server-processXHRError';

import { setCompression, addParameter, setEvent, getData, updateDom } from './server-util';
...
var ServerEvent = function ServerEvent(app) {
    babelHelpers.classCallCheck(this, ServerEvent);
